...
document.getElementById("printer-container").appendChild(renderer.domElement);
const textureLoader = new THREE.TextureLoader();
textureLoader.load(
	"render/player/ImphenziaPalette02-Albedo.jpg",
	function (texture) {
...
// fbxLoader.load('render/zombey.fbx', function (fbx) {
